...
const en: CalendarMessageCatalog = {
  ...
  'coar.calendar.month.moreEvents': '{count} more events',
  'coar.calendar.month.dayOverlayLabel': 'Events on {date}',
  'coar.calendar.month.dayOverlayClose': 'Close',
...
const de: CalendarMessageCatalog = {
  ...
  'coar.calendar.month.moreEvents': '{count} weitere Termine',
  'coar.calendar.month.dayOverlayLabel': 'Termine am {date}',
  'coar.calendar.month.dayOverlayClose': 'Schließen',
