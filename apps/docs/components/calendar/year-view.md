---
description: "CoarYearView — responsive twelve-month calendar overview with today marker and drill-in to the continuous Month view"
---

# `<CoarYearView>` — Year View <Badge type="warning" text="Preview" />
