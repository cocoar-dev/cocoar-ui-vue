      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Migrating to 2.11', link: '/guide/migration' },
            { text: 'Migrating Page Builder to 3.0', link: '/guide/migration-page-builder-3' },
      ...
      '/components/': [
        {
          ...
          items: [
            ...
            { text: 'Date · optional time', link: '/components/date-or-time-picker' },
